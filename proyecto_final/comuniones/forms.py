...
class BuscarComunionForm(BuscarSacramentoForm):
    """Campos específicos para buscar 'Comuniones'."""
...
class ComunionForm(SacramentoForm):
    """Contiene campos y validaciones para crear y modificar 'Comuniones'."""
    ...
    class Meta(SacramentoForm.Meta):
        ...
        2. Establecemos el modelo para guardar en la BD (Comunion).
